...
public class TwoStringSalesForceStaticParameterizationInTestNG extends BaseClassSalesForce{
	...
	public String[][] sendData() {
		...
		data[0][0]= "Testleaf";
		data [0][1]="Tester started 20205";
		data[1][1]="Mapway";
		data[1][1]="Been in hte industry for 5years";
	...
	public void runCreatLead(String company, String description) throws InterruptedException {
